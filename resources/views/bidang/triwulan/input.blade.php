...
@section('isi')
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('triwulan.store') }}" method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-floating">
                        ...
                        <input type="hidden" value="{{ $id }}" name="target_id">
                        <input type="number" class="form-control" id="floatingName" placeholder="Your Name" name="rea_k">
