        ...
        <div class="card-body">
            ...
            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                <div class="tab-pane fade" id="bordered-justified-home" role="tabpanel" aria-labelledby="home-tab">
                    <a href="{{ url('admin/kegiatan/create') . '/' . $program->kode }}"
                        class="btn btn-sm btn-primary mb-3"><i class="bi bi-plus"></i>
                        Tambah</a>
                    <div class="card mb-4">
                                        ...
                                        @foreach ($kegiatan as $k)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="show_ubah({{ $k->id }})" data-bs-toggle="modal"
                                                        data-bs-target="#ubahModal" class="btn btn-primary btn-sm "
                                                        title="Update"><i class="bi bi-box-arrow-in-up"></i></button>

                                                    <button onclick="deleteConfir({{ $k->id }})"
                                                        class="btn btn-danger btn-sm " title="kgtHapus"><i
                ...
                <div class="tab-pane fade active show" id="bordered-justified-profile" role="tabpanel"
                    ...
                    <div class="row mt-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <button onclick="show_modal()" type="button" class="btn btn-primary btn-sm w-100"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" align="center">DATA SUB KEGIATAN</h5>
